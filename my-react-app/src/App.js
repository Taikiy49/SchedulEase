...
<div className="app-container">
    ...
    <div className="chat-container">
        ...
        <img src="calendar-image.png" className="calendar-image"></img>
        <div className="example-options-container">
            <div className="option"><p>Option I</p></div>
            <div className="option"><p>Option II</p></div>
            <div className="option"><p>Option III</p></div>
        </div>
